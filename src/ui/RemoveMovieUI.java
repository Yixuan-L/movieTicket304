...
public class RemoveMovieUI extends JFrame {
...
//        contentPane.add(activeField);
        ...
        gb.setConstraints(removeMovie, c);
        contentPane.add(removeMovie);

        // register customer button with action event handler
        removeMovie.addActionListener(e -> this.delegate.deleteMovie(
                nameField.getText()
